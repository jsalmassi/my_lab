...
import hmac
## js
# the next lines will make the modues in /home/jsalmassi/my_projects/programmingbitcoin/code-ch06 avaiable 
...
hash160 = importlib.import_module('helper.hash160')
encode_base58_checksum = importlib.import_module('helper.encode_base58_checksum')
## end js
# the above 4 lines are equivalent to: the below one line, just becuse I have the helper module in a different directory
