...
from helper import encode_varint, hash256, int_to_little_endian,SIGHASH_ALL
from script import Script
from tx import Tx, TxIn #, SIGHASH_ALL, moved to helper import above
#from tests.test_tx import TxIn, TxOut, Tx #js
