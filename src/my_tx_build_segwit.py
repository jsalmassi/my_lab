# this script is just a copy of the my_tx_build_send.py file, but I will modify it to
#  work with segwit addresses and transactions, the diff between the two files is in
#  the my_tx_build_send3.py file, is that I am using the private key codes from the pybitcointools library to get the
#  private key and the public key, and not grabbing it from the electrum wallet.
